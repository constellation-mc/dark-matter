...
public final class RecipeBookHelper {
  ...
  public static void registerGroups(
      @NotNull RecipeBookCategory category, RecipeBookGroup... groups) {
  ...
  @Environment(EnvType.CLIENT)
  public static void registerGroups(
      @NotNull RecipeBookCategory category, int index, RecipeBookGroup... groups) {
  ...
  @Environment(EnvType.CLIENT)
  public static void registerGroups(
      @NotNull RecipeBookCategory category, List<RecipeBookGroup> groups) {
  ...
  @Environment(EnvType.CLIENT)
  public static void registerGroups(
      @NotNull RecipeBookCategory category, int index, @NotNull List<RecipeBookGroup> groups) {
  ...
  public static void addToSearchGroup(
      @NotNull RecipeBookGroup searchGroup, RecipeBookGroup... groups) {
  ...
  @Environment(EnvType.CLIENT)
  public static void addToSearchGroup(
      @NotNull RecipeBookGroup searchGroup, int index, RecipeBookGroup... groups) {
  ...
  @Environment(EnvType.CLIENT)
  public static void addToSearchGroup(
      @NotNull RecipeBookGroup searchGroup, @NotNull List<RecipeBookGroup> groups) {
  ...
  @Environment(EnvType.CLIENT)
  public static void addToSearchGroup(
      @NotNull RecipeBookGroup searchGroup, int index, @NotNull List<RecipeBookGroup> groups) {
   ...
   */
  @Environment(EnvType.CLIENT)
  public static void registerAndAddToSearch(
      @NotNull RecipeBookCategory category,
      @NotNull RecipeBookGroup searchGroup,
      RecipeBookGroup... groups) {
  ...
  public static void registerAndAddToSearch(
      @NotNull RecipeBookCategory category,
      @NotNull RecipeBookGroup searchGroup,
      @NotNull List<RecipeBookGroup> groups) {
    ClientRecipeBookUtils.registerGroups(category, groups);
  ...
  public static RecipeBookGroup createGroup(@NotNull Identifier id, ItemStack... stacks) {
    return ClientRecipeBookUtils.createGroup(
        id.toString().replace('/', '_').replace(':', '_'), stacks);
  }
