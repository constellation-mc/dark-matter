...
public class ReflectionInternals {
  ...
  public static @Nullable <T> Constructor<T> findConstructor(
  ...
  public static @Nullable <T> Method findMethod(
    ...
    return traverse && clazz.getSuperclass() != null
        ? findMethod(clazz.getSuperclass(), true, name, classes)
        : null;
  }
  ...
  public static <T> @Nullable Field findField(
    ...
    return traverse && clazz.getSuperclass() != null
        ? findField(clazz.getSuperclass(), true, name)
        : null;
  }
