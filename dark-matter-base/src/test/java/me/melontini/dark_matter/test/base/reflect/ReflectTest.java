...
public class ReflectTest {
    ...
    public void testFindMethodInHierarchy() {
        Assertions.assertThat(Reflect.findMethodInHierarchy(ReflectTestClass.Subclass.class, "privateMethod"))
                .isPresent();
    }

    @Test
    public void testFindFieldInHierarchy() {
        Assertions.assertThat(Reflect.findFieldInHierarchy(ReflectTestClass.Subclass.class, "privateField"))
                .isPresent();
    }
