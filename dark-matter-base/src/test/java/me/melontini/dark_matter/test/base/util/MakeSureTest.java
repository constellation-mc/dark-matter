...
public class MakeSureTest {
    ...
    public void testNotNulls() {
        ...
        Assertions.assertThatThrownBy(() -> MakeSure.notNulls("testNotNulls fail message", new Object(), null, new Object()))
                .isInstanceOf(NullPointerException.class)
    ...
    public void testIsTrue() {
        ...
        Assertions.assertThatThrownBy(() -> MakeSure.isTrue(new Object(), Objects::isNull, "testIsTrue fail message"))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("testIsTrue fail message");
    }
    ...
    public void testArrayNotEmpty() {
        ...
        Assertions.assertThatThrownBy(() -> MakeSure.notEmpty(new Object[0], "testArrayNotEmpty fail message"))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    public void testCollectionNotEmpty() {
        ...
        Assertions.assertThatThrownBy(() -> MakeSure.notEmpty(List.of(), "testCollectionNotEmpty fail message"))
                .isInstanceOf(IllegalArgumentException.class)
