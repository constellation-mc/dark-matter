...
public class GenericWrappersTest {
  ...
  public void testCreateGenericConstructor() {
    GenericConstructor<ReflectTestClass> constructor =
        GenericConstructor.of(ReflectTestClass.class, int.class, Integer.class, Object[].class);
  ...
  public void testCreateGenericMethod() {
    ...
    GenericMethod<ReflectTestClass, Void> method =
        GenericMethod.of(ReflectTestClass.class, "privateMethod");
  ...
  public void testCreateGenericField() {
    ...
    GenericField<ReflectTestClass, Integer> field =
        GenericField.of(ReflectTestClass.class, "privateField");
    Assertions.assertThat(field.accessible(true).get(inst)).isEqualTo(0xdeadbeef);
  }
}
