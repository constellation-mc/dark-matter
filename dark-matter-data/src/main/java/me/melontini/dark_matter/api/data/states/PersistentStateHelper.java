...
public final class PersistentStateHelper {
  ...
  public static <T extends PersistentState> void consumeIfLoaded(
      ServerWorld world,
      String id,
      BiFunction<ServerWorld, String, T> getFunc,
      Consumer<T> action) {
  ...
  public static <T extends PersistentState, R> Optional<R> processIfLoaded(
      ServerWorld world,
      String id,
      BiFunction<ServerWorld, String, T> getFunc,
      Function<T, R> action) {
