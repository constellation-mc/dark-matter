...
public class ExtraCodecsUnitTest {
    ...
    public void testColorCodecArrays(String value) {
        ...
        int intended = ColorUtil.toColor(array.get(0).getAsInt(), array.get(1).getAsInt(), array.get(2).getAsInt());

        int color = parse(ExtraCodecs.COLOR, array);
        Assertions.assertThat(color).isEqualTo(intended);

        Assertions.assertThat(encode(ExtraCodecs.COLOR, color))
                .isEqualTo(new JsonPrimitive(intended));
    }
    ...
    public void testMapLookupCodec() {
        ...
        Assertions.assertThat(parse(codec, new JsonPrimitive("dark_matter:two")))
                .isEqualTo(2);
    ...
    public void testEnumCodec() {
        ...
        Assertions.assertThat(parse(codec, new JsonPrimitive("first")))
