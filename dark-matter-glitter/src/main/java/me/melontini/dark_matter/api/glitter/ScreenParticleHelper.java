...
public final class ScreenParticleHelper {
  ...
  public static void addParticle(
      ParticleEffect parameters, double x, double y, double velX, double velY) {
  ...
  public static void addParticles(
      ...
      double speed,
      int count) {
    ScreenParticleInternals.addScreenParticles(
        null, parameters, x, y, deltaX, deltaY, speed, count);
  }
  ...
  public static void addScreenParticle(
      Screen screen, ParticleEffect parameters, double x, double y, double velX, double velY) {
  ...
  public static void addScreenParticles(
      ...
      int count) {
    ScreenParticleInternals.addScreenParticles(
        screen, parameters, x, y, deltaX, deltaY, speed, count);
  }
