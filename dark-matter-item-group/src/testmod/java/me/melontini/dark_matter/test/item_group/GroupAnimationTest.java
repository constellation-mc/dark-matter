...
public class GroupAnimationTest implements ClientModInitializer, ClientTestEntrypoint {
  ...
  public void onInitializeClient() {
    ...
    ItemGroupAnimaton.setIconAnimation(
        GroupBuilderTest.group, (group, context, itemX, itemY, selected, isTopRow) -> {
          BakedModel model =
          ...
          context
              .getMatrices()
              .multiply(RotationAxis.NEGATIVE_Z.rotationDegrees(Util.getMeasuringTimeMs() * 0.05f));
  ...
  public void onClientTest(ClientTestContext context) {
    context.setScreen(client ->
        new CreativeInventoryScreen(client.player, client.world.getEnabledFeatures(), false));
