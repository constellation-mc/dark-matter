...
public class DrawUtil {
  ...
  public static void fillGradientHorizontal(
      ...
      int colorEnd,
      float z) {
    DrawInternals.fillGradientHorizontal(
        matrices, startX, startY, endX, endY, colorStart, colorEnd, z);
  }
  ...
  public static void drawTexture(
      ...
      float textureHeight) {
    DrawInternals.drawTexture(
        matrices, x0, x1, y0, y1, z, regionWidth, regionHeight, u, v, textureWidth, textureHeight);
  }
