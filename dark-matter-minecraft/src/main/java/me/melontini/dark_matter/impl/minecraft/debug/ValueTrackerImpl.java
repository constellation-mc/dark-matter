...
public class ValueTrackerImpl {
  ...
  public static void addTracker(
      @NonNull String trackerName, @NonNull Supplier<?> supplier, @NonNull Duration duration) {
    TRACKERS.put(trackerName, supplier);
    TIMERS.put(trackerName, Tuple.of(Instant.now(), duration));
  }

  public static void addFieldTracker(
      @NonNull String trackerName, @NonNull Field f, @NonNull Object o) {
  ...
  public static void addStaticFieldTracker(
      @NonNull String trackerName, @NonNull Field f, @NonNull Duration duration) {
    Reflect.setAccessible(f);
    TRACKERS.put(trackerName, () -> {
      try {
        return f.get(null);
  ...
  public static void tick() {
    ...
    ValueTrackerImpl.getView()
        .forEach((id, supplier) -> DARK_MATTER$VALUES_TO_RENDER.add(id + ": " + supplier.get()));
  }
