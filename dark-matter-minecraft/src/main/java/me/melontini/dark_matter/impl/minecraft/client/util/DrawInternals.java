...
public class DrawInternals {
  ...
  public static void renderTooltip(
      DrawContext context, List<Text> lines, Optional<TooltipData> data, float x, float y) {
    context.getMatrices().push();
    context.getMatrices().translate(x - (int) x, y - (int) y, 0);
  ...
  public static void renderOrderedTooltip(
      DrawContext context, List<? extends OrderedText> lines, float x, float y) {
    context.getMatrices().push();
    context.getMatrices().translate(x - (int) x, y - (int) y, 0);
  ...
  public static void renderTooltipFromComponents(
      DrawContext context, List<TooltipComponent> components, float x, float y) {
    context.getMatrices().push();
    context.getMatrices().translate(x - (int) x, y - (int) y, 0);
    context.drawTooltip(
  ...
  public static void renderTooltipFromComponents(
    ...
    context.getMatrices().translate(x - (int) x, y - (int) y, 0);
    context.drawTooltip(
        MinecraftClient.getInstance().textRenderer, components, (int) x, (int) y, positioner);
    context.getMatrices().pop();
  }
  ...
  public static void fillGradient(
    ...
    float f = ColorUtil.getAlphaF(colorStart),
        g = ColorUtil.getRedF(colorStart),
        h = ColorUtil.getGreenF(colorStart),
        i = ColorUtil.getBlueF(colorStart);
    float j = ColorUtil.getAlphaF(colorEnd),
        k = ColorUtil.getRedF(colorEnd),
        l = ColorUtil.getGreenF(colorEnd),
        m = ColorUtil.getBlueF(colorEnd);
  ...
  public static void drawTexture(
      ...
      float textureHeight) {
    drawTexture(
        matrices, x, x + width, y, y + height, z, width, height, u, v, textureWidth, textureHeight);
  }
  ...
  public static void renderGuiItemModelCustomMatrixNoTransform(
      MatrixStack matrixStack, ItemStack stack, BakedModel model) {
  ...
  public static void renderGuiItemModelCustomMatrix(
      MatrixStack matrixStack, ItemStack stack, float x, float y, BakedModel model) {
    MinecraftClient client = MinecraftClient.getInstance();
